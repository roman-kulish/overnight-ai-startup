...
export default async function handle(
  ...
  // Future: _env.AI.run(_env.MODEL_VC_ROAST, { ... }, { gateway: { id: _env.AI_GATEWAY_VC_ROAST } })
  ...
  const validation = validateInput('roast', body);
  ...
  return jsonResponse({
    ok: true,
    output: 'Generated content goes here for roast',
  });
}
